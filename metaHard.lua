...
function SpatialConvolutionMetaHard:__init(nInputPlane, nOutputPlane,
   ...
   if outR > 0 then
      ...
      local log = string.format("%10.2f %10.2f %10.2f %10.2f %10.2f %10.2f %10.2f %10.2f %10.2f %10.2f %10.2f %10.2f ", timeOut[1], timeOut[2], timeOut[3], timeOut[4], timeGradInput[1], timeGradInput[2], timeGradInput[3], timeGradInput[4]
         , timeGradPara[1], timeGradPara[2], timeGradPara[3], timeGradPara[4])
