...
do
	...
	SKIP=legacy python pylearn2_benchmark_CorrMM.py >> ./test/batch-CorrMM-output.txt 2>&1
...
do
        ...
        SKIP=legacy python pylearn2_benchmark_CorrMM.py >> ./test/input-CorrMM-output.txt 2>&1
...
do
        sed -i "44s/'no': .*/'no': "$val",/" pylearn2_benchmark_CorrMM.py
        echo " filters: $val "

        SKIP=legacy python pylearn2_benchmark_CorrMM.py >> ./test/filter-CorrMM-output.txt 2>&1
...
do
        sed -i "45s/'kw': .*/'kw': "$val",/" pylearn2_benchmark_CorrMM.py
        sed -i "46s/'kh': .*/'kh': "$val",/" pylearn2_benchmark_CorrMM.py
        echo " ksize: $val "

        SKIP=legacy python pylearn2_benchmark_CorrMM.py >> ./test/ksize-CorrMM-output.txt 2>&1
...
do
        ...
        SKIP=legacy python pylearn2_benchmark_CorrMM.py >> ./test/stride-CorrMM-output.txt 2>&1
