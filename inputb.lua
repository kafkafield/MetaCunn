...
runs = {
   
   {
      -- first layer
      ni = 3,
      no = 64, --support 32,64,96,128,192,256
      kw = 11,
      kh = 11,
      iw = 128,
      ih = 128,
...
inputs = { 32,48,64,80,96,112,128,144,160,176,192,208,224,240,256 }


for value, input in ipairs(inputs) do
for i,run in ipairs(runs) do
   -- params for run:
   local ni,no,bs,kw,kh,iw,ih,dw,dh = run.ni,run.no,run.bs,run.kw,run.kh,run.iw,run.ih,run.dw,run.dh
   iw = input
   ih = input 
   print('')
