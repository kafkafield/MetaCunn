...
cd /home/jedy/deeplearning/convnet-benchmarks-master/caffe/caffe/test_new/runtime
./cuDNN-version-change/v2-to-v3.sh


cd /home/jedy/deeplearning/convnet-benchmarks-master/caffe

# collect flop counts for caffe original
nvprof --csv --metrics achieved_occupancy,ipc,warp_execution_efficiency,gld_efficiency,gst_efficiency,shared_efficiency ./caffe/build/tools/caffe time --model=proto_forceGradInput/conv1.prototxt --iterations=1 --gpu 0 --logtostderr=1 >>./flops_caffe/metrics_cuDNN_conv1.txt 2>&1
nvprof --csv --metrics achieved_occupancy,ipc,warp_execution_efficiency,gld_efficiency,gst_efficiency,shared_efficiency ./caffe/build/tools/caffe time --model=proto_forceGradInput/conv2.prototxt --iterations=1 --gpu 0 --logtostderr=1 >>./flops_caffe/metrics_cuDNN_conv2.txt 2>&1
nvprof --csv --metrics achieved_occupancy,ipc,warp_execution_efficiency,gld_efficiency,gst_efficiency,shared_efficiency ./caffe/build/tools/caffe time --model=proto_forceGradInput/conv3.prototxt --iterations=1 --gpu 0 --logtostderr=1 >>./flops_caffe/metrics_cuDNN_conv3.txt 2>&1
nvprof --csv --metrics achieved_occupancy,ipc,warp_execution_efficiency,gld_efficiency,gst_efficiency,shared_efficiency ./caffe/build/tools/caffe time --model=proto_forceGradInput/conv4.prototxt --iterations=1 --gpu 0 --logtostderr=1 >>./flops_caffe/metrics_cuDNN_conv4.txt 2>&1
nvprof --csv --metrics achieved_occupancy,ipc,warp_execution_efficiency,gld_efficiency,gst_efficiency,shared_efficiency ./caffe/build/tools/caffe time --model=proto_forceGradInput/conv5.prototxt --iterations=1 --gpu 0 --logtostderr=1 >>./flops_caffe/metrics_cuDNN_conv5.txt 2>&1
