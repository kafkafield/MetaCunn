...
nvprof --csv --metrics flops_sp ./caffe/build/tools/caffe time --model=proto_forceGradInput/conv1.prototxt --iterations=1 --gpu 0 --logtostderr=1 >>./flops_cuDNN/flops_cuDNN_conv1.txt 2>&1
nvprof --csv --metrics flops_sp ./caffe/build/tools/caffe time --model=proto_forceGradInput/conv2.prototxt --iterations=1 --gpu 0 --logtostderr=1 >>./flops_cuDNN/flops_cuDNN_conv2.txt 2>&1
nvprof --csv --metrics flops_sp ./caffe/build/tools/caffe time --model=proto_forceGradInput/conv3.prototxt --iterations=1 --gpu 0 --logtostderr=1 >>./flops_cuDNN/flops_cuDNN_conv3.txt 2>&1
nvprof --csv --metrics flops_sp ./caffe/build/tools/caffe time --model=proto_forceGradInput/conv4.prototxt --iterations=1 --gpu 0 --logtostderr=1 >>./flops_cuDNN/flops_cuDNN_conv4.txt 2>&1
nvprof --csv --metrics flops_sp ./caffe/build/tools/caffe time --model=proto_forceGradInput/conv5.prototxt --iterations=1 --gpu 0 --logtostderr=1 >>./flops_cuDNN/flops_cuDNN_conv5.txt 2>&1
